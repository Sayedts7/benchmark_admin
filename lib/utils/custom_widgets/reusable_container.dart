          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(projectName, style: AppTextStylesInter.label13600PTC),
                  Text('Exp. $expiryDate', style:AppTextStylesInter.label10500STC,),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
...
class ReusableContainer extends StatelessWidget {
  ...
  const ReusableContainer({super.key,
   this.height = 50,
  required this.width, required this.bgColor,
    required this.child
});
...
class ReusableContainer2 extends StatelessWidget {
  ...
  const ReusableContainer2({super.key,
    this.height = 50,
    required this.width, required this.bgColor,
    required this.child
  });
...
class ReusableContainer3 extends StatelessWidget {
  ...
  const ReusableContainer3({super.key,
